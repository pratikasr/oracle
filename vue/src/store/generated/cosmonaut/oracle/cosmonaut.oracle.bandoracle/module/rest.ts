...
export type BandoracleMsgFetchPriceDataResponse = object;

/**
 * Params defines the parameters for the module.
 */
export type BandoracleParams = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<BandoracleQueryParamsResponse, RpcStatus>({
      path: `/cosmonaut/oracle/bandoracle/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryFetchPriceResult = (requestId: string, params: RequestParams = {}) =>
    this.request<BandoracleQueryFetchPriceResponse, RpcStatus>({
      path: `/oracle/bandoracle/fetch_price_result/${requestId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryLastFetchPriceId = (params: RequestParams = {}) =>
    this.request<BandoracleQueryLastFetchPriceIdResponse, RpcStatus>({
      path: `/oracle/bandoracle/last_fetch_price_id`,
      method: "GET",
      format: "json",
      ...params,
    });
