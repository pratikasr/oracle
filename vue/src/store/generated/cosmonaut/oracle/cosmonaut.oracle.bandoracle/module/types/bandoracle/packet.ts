...
const baseBandoraclePacketData: object = {}

export const BandoraclePacketData = {
  encode(message: BandoraclePacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): BandoraclePacketData {
    ...
    const message = { ...baseBandoraclePacketData } as BandoraclePacketData
